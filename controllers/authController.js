const { signupSchema, signinSchema, acceptCodeSchema, changePasswordSchema, forgotPasswordSchema, acceptForgotPasswordSchema } = require("../middlewares/validator");
...
exports.sendVerificationCode = async (req,res) => {
    ...
    try {
        ...
        let info = await transport.sendMail({
            ...
            subject:"verification code for car service",
